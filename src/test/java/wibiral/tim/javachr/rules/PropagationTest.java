...
public class PropagationTest {
    ...
    public void setUp() {
        ...
        rule1.body((oldC, newC) -> newC.add(new Constraint<Integer>((int) oldC[0].value() - 1)));
   }
    ...
    public void apply() {
        ...
        assertFalse("Too many constraints, must be false!", rule1.apply(new ConstraintStore(12, 7)));
        assertFalse("Too few constraints, must be false!", rule1.apply(new ConstraintStore()));

        assertFalse("Constraints don't fulfill the conditions, must be false!", rule1.apply(new ConstraintStore(42)));
        assertFalse("Constraints don't fulfill the conditions, must be false!", rule1.apply(new ConstraintStore(-12)));
    }
