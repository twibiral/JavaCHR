...
public class GreatestCommonDivisor {
    public static void main(String[] args) {
        ...
        start = System.currentTimeMillis(); // Stop time and print it
        result = gcdHandlerParallel.solve(27, 9);
        end = System.currentTimeMillis();
        System.out.println("Duration (parallel): " + (end - start) + "ms\n" + result + "\n");
        ...
        System.out.println("Duration: " + (end - start) + "ms");
        start = System.currentTimeMillis(); // Stop time and print it
        result = gcdHandlerParallel.solve(1337, 42);
        end = System.currentTimeMillis();
        System.out.println("Duration (parallel): " + (end - start) + "ms\n" + result + "\n");
        ...
        System.out.println("Duration: " + (end - start) + "ms");
        start = System.currentTimeMillis(); // Stop time and print it
        result = gcdHandlerParallel.solve(11, 253, 25751);
        end = System.currentTimeMillis();
        System.out.println("Duration (parallel): " + (end - start) + "ms\n" + result + "\n");
        ...
        System.out.println("Duration: " + (end - start) + "ms");
        start = System.currentTimeMillis(); // Stop time and print it
        result = gcdHandlerParallel.solve(12312, 12132, 112, 4234, 1211);
        end = System.currentTimeMillis();
        System.out.println("Duration (parallel): " + (end - start) + "ms\n" + result + "\n");
        ...
        System.out.println("Duration: " + (end - start) + "ms");
        start = System.currentTimeMillis(); // Stop time and print it
        result = gcdHandlerParallel.solve(9897392, 2837812, 1211, 283749);
        end = System.currentTimeMillis();
        System.out.println("Duration (parallel): " + (end - start) + "ms\n" + result + "\n");
